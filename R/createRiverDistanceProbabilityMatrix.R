...
#' sites are loaded from .csv whose file name is specified as input `filepath_river_distances`.
...
#'
createRiverDistanceProbabilityMatrix <- function(filepath_river_distances,
