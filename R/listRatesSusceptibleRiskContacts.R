...
#'
#' Note: this function is called within `aquanet::updateRates` and `aquanet::calcRiverTransmission`
#' of AquaNet-Mod.
#'
...
#' filtered depending on catchment controls input into `aquanet::excludeWithinCatchmentMovements()`.
#'
...
#' `aquanet::updateRates` function of AquaNet-Mod. In AquaNet-Mod this is one of the outputs
#' from `aquanet::excludeWithinCatchmentMovements()`).
#'
...
#' (Note: created within the `aquanet::simulationCode` function for loop).
#'
...
#'
listRatesSusceptibleRiskContacts <- function(spmatrix_risk_contacts,
                                             state_vector,
                                             trans_type) {
