...
combineTransitionRates <- function(list_append, list_base) {
  ...
  list_base[[1]] <- c(list_base[["rate_type"]], list_append[["rate_type"]])
  list_base[[2]] <- c(list_base[["position"]], list_append[["position"]])
  list_base[[3]] <- c(list_base[["rate"]], list_append[["rate"]])
  list_base[[4]] <- c(list_base[["source"]], list_append[["source"]])
