...
commitResults <- function(df_states,
  ...
  # merge simulation data with true siteID and reorder cols
  sims <- merge(sims, df_site_names, by = "modelID", all.x = TRUE)
  sims <- sims[ , c("modelID", "siteID", "state", "timeID", "simNo", "tdiff", "t")]
